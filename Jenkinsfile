...
node ('R&&manja'){
    ...
    sh 'docker container run --rm -i --name  r-project -v "$PWD":/usr/src/r-base -w /usr/src/r-base r-base Rscript -e "load(\'model.rda\'); print(model); save(model, file = \'/home/ubuntu/larma/model.rda\')"'
